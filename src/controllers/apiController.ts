...
import { CryptoData, cryptoDataSchema } from '../models/cryptoData';
import {
  MarketDataResponse,
...
} from '../models/marketMultiDataResponse';
...
import {
  SearchCryptoData,
  searchCryptoDataSchema,
} from '../models/searchCryptoData';
import {
...
export class ApiController extends BaseController {
  ...
  async fetchCryptoDataByName(
    ...
    return req.callAsJson(array(searchCryptoDataSchema), requestOptions);
  }
  ...
  async fetchAllCryptoDetails(
    ...
    return req.callAsJson(array(cryptoDataSchema), requestOptions);
  }
  ...
  async fetchMultipleAssetMarketData(
    ...
    return req.callAsJson(marketMultiDataResponseSchema, requestOptions);
  }
